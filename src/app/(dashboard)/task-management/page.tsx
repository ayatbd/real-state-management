  ...
  return (
    <div className="grid grid-cols-2">
      ...
      <div className="w-full max-w-4xl mx-auto p-4 space-y-6 font-sans">
        {/* Top Heading Box */}
        <div className="w-full border-2 border-[#a33b87] bg-white rounded-lg py-2 text-center shadow-sm">
          <h1 className="text-xl md:text-xl font-bold text-[#a33b87]">
            Assigned To Me
          </h1>
        </div>
