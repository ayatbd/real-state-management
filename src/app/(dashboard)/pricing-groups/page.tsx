...
const categories = [
  { id: "01", client_number: "5", name: "Photos" },
  { id: "02", client_number: "5", name: "Videos" },
  { id: "03", client_number: "5", name: "Floorplans" },
  { id: "04", client_number: "5", name: "Artist Impressions" },
  { id: "05", client_number: "5", name: "Energy Labels" },
  { id: "06", client_number: "5", name: "Virtual Tour" },
];
export default function SidebarPackagesPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-8">
      ...
      {/* Action Button */}
      <div className="mb-6">
        <Link href="/pricing-groups/new-pricing-group">
        ...
        <Table className="table-fixed w-full">
          <TableHeader>
            <TableRow className="border-none hover:bg-transparent">
              ...
              <TableHead className="w-1/3 text-slate-900 font-bold text-lg text-center">
                Number of Client
              </TableHead>
          ...
          <TableBody>
            {categories.map((item) => (
              <TableRow key={item.id} className="border-none hover:bg-slate-50">
                ...
                <TableCell className="py-6 text-slate-700 font-medium text-center">
                  {item.client_number}
                </TableCell>
                <TableCell className="py-6 text-right">
                  <div className="flex justify-end gap-2 pr-4">
                    <Link href="/pricing-groups/edit-pricing-group">
                      <Button
                        size="icon"
                        className="bg-[#2A206A] hover:bg-[#1e174d] w-9 h-9"
                      >
